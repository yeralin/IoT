...
<script type="text/x-red" data-template-name="www-request">
    ...
    <div class="form-row">
        <input type="checkbox" id="node-input-persistent-http" style="display: inline-block; width: auto; vertical-align: top;">
        <label for="node-input-persistent-http" style="width: auto" data-i18n="httpin.persistent-http"></label>
    </div>
