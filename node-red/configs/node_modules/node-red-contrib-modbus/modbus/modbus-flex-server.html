...
<code>msg.payload = { 'value': msg.payload, 'register': 'holding', 'address': 1 , 'disablemsg' : 0 }; return msg;</code>
</p> <p>Valid registers are:</p><ul><li>holding</li><li>coils</li><li>input</li><li>discrete</li></ul>
 Set disablemsg to 1, if you want to disable the Flex Server outputs when injecting.<p></p> </script> 